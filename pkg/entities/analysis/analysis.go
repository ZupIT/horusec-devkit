...
type Analysis struct {
	...
	AnalysisVulnerabilities []RelationshipAnalysisVuln `json:"analysisVulnerabilities" gorm:"foreignKey:AnalysisID;references:ID"` //nolint:lll // notations need more than 130 characters
}
