...
type RelationshipAnalysisVuln struct {
	...
	Vulnerability   vulnerability.Vulnerability `json:"vulnerabilities" gorm:"foreignKey:VulnerabilityID;references:VulnerabilityID;polymorphicValue:analysis_vulnerabilities"` //nolint:lll // notations need more than 130 characters
}
